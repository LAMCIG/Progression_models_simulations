...
param_grid = {
    "lambda_f": [0.5, 0.95],
    "lambda_cog": [0.01, 0.05],
    "lambda_scalar": [0.0, 0.55],
    "jac_toggle": [True],
    "max_iter": [20],
    "t_max": [40],
    "epsilon": [1e-1],
...
out_path = "/home/dsemchin/Progression_models_simulations/EMDPM/experiments/qsub_jobs/qsub_results/em_best_model_68biom_reduced.npz"
