...
param_grid = {
    "lambda_f": [0.4, 0.5, 0.7, 0.9, 1.0],
    "lambda_cog": [0.01, 0.05, 0.1, 0.25],
    "lambda_scalar": [0.0, 0.1, 0.3, 0.5, 0.7],
    "jac_toggle": [True],
    "max_iter": [30],
    "t_max": [40],
    "epsilon": [1e-1],
...
out_path = "/home/dsemchin/Progression_models_simulations/EMDPM/experiments/qsub_jobs/qsub_results/em_best_model_68biom_full.npz"
