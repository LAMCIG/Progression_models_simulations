...
param_grid = {
    "lambda_f": [0.4, 0.5, 0.6, 0.7], #,[0.5, 1.0, 1.5],
    "lambda_cog": [0.1, 0.2, 0.3], #[0.01, 0.05, 0.1],
    "lambda_scalar": [1.1], #[0.1, 0.3, 0.5],
    "lambda_jsd": [0.0, 0.1, 0.5, 1.0, 5.0, 10.0, 50.0, 1e1, 5e2, 1e3, 1e4, 1e5], #[0.0, 0.05, 0.1, 0.15],
