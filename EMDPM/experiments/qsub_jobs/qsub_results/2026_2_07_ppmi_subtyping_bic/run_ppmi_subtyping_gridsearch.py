...
N_SUBTYPES_LIST = [1, 2, 3, 4]  # candidate number of subtypes; select among these by BIC

# Hyperparameter grid (no n_subtypes): tuned by CV within each K
param_grid_hyper = {
    "lambda_f": [0.5, 0.75, 1.0, 1.25],
    "lambda_cog": [0.0, 0.15, 0.25, 0.35],
    "lambda_scalar": [0.1, 0.5, 0.75, 1.0, 1.25],
    "lambda_jsd": [0, 10, 100, 1000, 10000],
    "lambda_beta": [0.0]
}
